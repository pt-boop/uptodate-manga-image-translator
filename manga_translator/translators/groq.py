...
class GroqTranslator(CommonTranslator):
    ...
    'Proper names must be transcribed exactly as they appear in the source text, using standard Hepburn romanization without any abbreviation, truncation, or creative modification. For example, "弥生" must be rendered as "Yayoi" and not as "yayo".'
