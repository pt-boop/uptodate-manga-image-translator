...
class GroqTranslator(CommonTranslator):
    ...
    'Proper names must always be accurately romanized following standard Hepburn romanization without any abbreviation or truncation. '
    'For instance, "弥生" must be rendered as "Yayoi" and not abbreviated to "yayo". '
